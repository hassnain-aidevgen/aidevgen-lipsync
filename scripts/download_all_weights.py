...
def download_all_models():
    ...
    download(
        ...
        f"{MODELS_DIR}/musetalk/pytorch_model.bin"
    )
    download(
    ...
    download(
        ...
        f"{MODELS_DIR}/syncnet/latentsync_syncnet.pt"
    )
    # DWPose
    download(
    ...
    download(
        ...
        f"{MODELS_DIR}/sd-vae/diffusion_pytorch_model.bin"
    )
    # Whisper
    download(
    ...
    download(
        ...
        f"{MODELS_DIR}/whisper/pytorch_model.bin"
    )
    download(
        "https://huggingface.co/openai/whisper-tiny/resolve/main/preprocessor_config.json",
        f"{MODELS_DIR}/whisper/preprocessor_config.json"
    )
